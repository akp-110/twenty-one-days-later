...
ActiveRecord::Schema[7.2].define(version: 2025_06_02_143932) do

ActiveRecord::Schema[7.2].define(version: 2025_06_02_094826) do
  ...
  create_table "goal_completions", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_goal_completions_on_user_id"
  end
  ...
  add_foreign_key "goal_completions", "users"
